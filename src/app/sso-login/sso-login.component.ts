...
export class SSOLoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    // 自網址上取得 lightID 參數
    this.lightID = new URLSearchParams(window.location.search).get("token");
    ...
    if(!this.loginService.userProfile.consoleGroup || !this.loginService.userProfile.consoleGroup.consoleGroupScope){
